...
class EconomicWithdrawalService:
    ...
    def create_pledge(
        ...
        if datetime.utcnow() > campaign.pledge_deadline:
    ...
    def activate_pledges_for_campaign(self, campaign_id: str):
        ...
        for pledge in pledges:
            if pledge.status == PledgeStatus.COMMITTED:
                ...
                pledge.updated_at = datetime.utcnow()
    ...
    def commit_to_bulk_buy(
        ...
        if datetime.utcnow() > bulk_buy.commitment_deadline:
        ...
        bulk_buy.updated_at = datetime.utcnow()
